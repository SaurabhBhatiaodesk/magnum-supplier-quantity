...
function DefaultSettingsPopup({
    ...
    console.log("locationOptionslocationOptions",locationOptions);
    ...
    console.log("locationInputValue",locationInputValue);
        console.log("filteredLocationOptions",filteredLocationOptions);
...
export default function CsvFileScreen() {
    ...
    const locationOptions = useMemo(() => {
        ...
        console.log("fetchLocationsfetchLocations",fetchLocations);
